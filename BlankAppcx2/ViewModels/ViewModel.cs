...
namespace BlankAppcx2.ViewModels
{
    public class ViewModel : ModelBase
    {
        ...
        private PersonQuery _personQuery;
        public PersonQuery personQuery
        {
            get { return _personQuery ?? (_personQuery = new PersonQuery()); }
        ...
        public BindingList<Person> GetAll()
        {
            ...
            var s = HttpHelper.HttpGet($"https://localhost:44311/api/services/app/APJUser/GetQuerycondition?materialAllocationTableCoding={personQuery.MaterialAllocationTableCoding}&materialAllocationTableDescribe={personQuery.MaterialAllocationTableTab}");
            
            var show = JsonConvert.DeserializeObject<Root1>(s);
